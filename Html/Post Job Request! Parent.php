...
<html>
  ...
  <body >
    ...
    <form action="Post Request! Parent.php" method="post">
        <div class="modal" id="modal-request">
            ...
            <div class="modal-left" id="modal-left-req">
                ...
                <label class="input-label">Start Date:</label>
                 <input name="sdate" type="date"  class="Duration">
              
                 <label class="input-label">End Date:</label>
                 <input name="edate" type="date" class="Duration">
                </div>

               <div class="input-block">
                <label class="input-label">Start time:</label>
                 <input name="stime" type="time"  class="Duration">
            
                 <label class="input-label">End time:</label>
                 <input name="etime" type="time"  class="Duration">
                 </div>
